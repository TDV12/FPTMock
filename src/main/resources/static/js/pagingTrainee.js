...
var emplIdSearch2 = $("#traineeCandidateId2").val();
...
$("#pagination").twbsPagination({
    ...
    onPageClick: function (event, page) {
        ...
        if (currentPage != page) {
            ...
            $.get({
                url: "./traineeListing?currentPage=" + page +"&&sizePage=" + sizePage2 + "&&traineeCandidateId=" + emplIdSearch2 + "&&account=" + accountSearch + "&&fullName=" + nameSearch + "&&dateOfBirth=" + DOBSearch + "&&phone=" + phoneSearch + "&&email=" + emailSearch,
